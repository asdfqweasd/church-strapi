...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    title3: Schema.Attribute.String & Schema.Attribute.Required;
    title3Description: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroDescriptionRichtext: Schema.Attribute.Blocks;
    ...
    > &
      Schema.Attribute.Private;
    ministriesDescription: Schema.Attribute.Text;
    ministriesImg: Schema.Attribute.Media<
...
export interface ApiMinistriesPageMinistriesPage
  extends Struct.SingleTypeSchema {
  collectionName: 'ministries_pages';
  info: {
    displayName: 'MinistriesPage';
    pluralName: 'ministries-pages';
    singularName: 'ministries-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ministries-page.ministries-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title1Description: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    title3: Schema.Attribute.String & Schema.Attribute.Required;
    title3Description: Schema.Attribute.Text & Schema.Attribute.Required;
    title4: Schema.Attribute.String & Schema.Attribute.Required;
    title4Description: Schema.Attribute.Text & Schema.Attribute.Required;
    title5: Schema.Attribute.String & Schema.Attribute.Required;
    title5Description: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ministries-page.ministries-page': ApiMinistriesPageMinistriesPage;
